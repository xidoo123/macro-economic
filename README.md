...
* Okun's law 的核心观点是，失业率和实际GDP之间存在一种稳定的负相关关系。具体而言，奥肯发现，当实际GDP增长时，失业率下降，反之亦然。2% GDP 增长 = 1% 失业率减少
...
* Business cycle models
    ...
    * Real Business Cycle models
        ...
        * 考虑 positive and negative technology shocks
            ...
            * negative shock -> price rises, output decreases
...
* Keynesian cross 描述的是一个 short run 的现象
...
* Aggregate Demand 曲线
    ...
    * 曲线斜率是负的的解释
        ...
        * The Wealth Effect：price level 降低让人觉得更富，愿意花更多的钱 -> demand 上升

        * The Interest Rate Effect：price level 上升，real interest rate 上升（money quantity 与 利率的那个图，demand 右移，交点的 利率 上升），借钱更贵，更不愿意投资 -> demand 减少

        * The Exchange-Rate Effect：price level 降低，利率减少，国外更想买国内的东西，国内 export 上升，也就需要产出更多的东西，demand 增加
...
* Aggregate Supply 曲线
    ...
    * 曲线斜率是正的的解释
        ...
        * The Sticky-Wage Theory：price level 下降，由于 wage 是 sticky 的所以短期内不会变，工人会觉得收入降低，公司也觉得赚钱少了，所以 supply 下降

        * The Sticky-Price Theory

        * The Misperceptions Theory

        * Y = Y^ + a * (P - P^e)，P^e 是 expectation
